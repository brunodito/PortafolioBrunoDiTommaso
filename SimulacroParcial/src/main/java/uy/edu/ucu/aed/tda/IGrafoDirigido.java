...
public interface IGrafoDirigido {
    ...
    Collection<Ciudad> bpf();

    Collection<Ciudad> bea();

    Collection<Ciudad> bpf(Ciudad vertice);

    Collection<Ciudad> bpf(Comparable etiquetaOrigen);
     ...
     */
    boolean insertarArista(Ruta arista);
     ...
     */
    boolean insertarVertice(Ciudad vertice);
