...
public class TGrafoDirigido implements IGrafoDirigido {
    ...
    public void asignarNum(Comparable etiqueta) {
    ...
    public void clasificarArcos(Comparable primero, Collection<TArista> arcosArbol,  Collection<TArista> arcosAvance, Collection<TArista> arcosRetroceso, Collection<TArista> arcosCRruzados) {
        Collection<TArista> arcos = obtenerAristas();
        TVertice inicial = buscarVertice(primero);
        inicial.asignarNum(1);
        for (TVertice vertice : vertices.values()) {
            if (!vertice.getVisitado()) {
                vertice.asignarNum(1);
            }
        }
        for (TVertice vertice : vertices.values()) {
            vertice.setVisitado(false);
        }
        inicial.clasificarArcos(arcosArbol, arcosAvance, arcosRetroceso, arcosCRruzados);
    }

    public void imprimirArcos(Collection<TArista> arcosArbol, Collection<TArista> arcosAvance, Collection<TArista> arcosRetroceso, Collection<TArista> arcosCRruzados) {
        System.out.println("Arcos de Arbol");
        for (TArista arco : arcosArbol) {
            System.out.print(arco.getEtiquetaOrigen() + " -> " + arco.getEtiquetaDestino() + " / ");
        }
        System.out.println();
        System.out.println("Arcos de Avance");
        for (TArista arco : arcosAvance) {
            System.out.print(arco.getEtiquetaOrigen() + " -> " + arco.getEtiquetaDestino() + " / ");
        }
        System.out.println();
        System.out.println("Arcos de Retroceso");
        for (TArista arco : arcosRetroceso) {
            System.out.print(arco.getEtiquetaOrigen() + " -> " + arco.getEtiquetaDestino() + " / ");
        }
        System.out.println();
        System.out.println("Arcos de CRruzados");
        for (TArista arco : arcosCRruzados) {
            System.out.print(arco.getEtiquetaOrigen() + " -> " + arco.getEtiquetaDestino() + " / ");
        }
    }
    ...
    public Collection<TArista> obtenerAristas(){
        ...
        for (TVertice vertice : vertices.values()) {
            for (Object adyacencia : vertice.getAdyacentes()) {
                ...
                TArista arista = new TArista(vertice.getEtiqueta(), ady.getDestino().getEtiqueta(), ady.getCosto());
